  ...
  <div class="content-wrapper py-8">
    <div class="max-w-xl mx-auto">
      ...
      <p class="text-gray-500 dark:text-gray-400 mb-8">
        Your feedback helps other traders discover Teejarah Trading. Even a sentence or two goes a long way.
      </p>
      ...
      <form v-else @submit.prevent="submitReview" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows="4"
            maxlength="2000"
            placeholder="What's been most helpful about Teejarah Trading?"
