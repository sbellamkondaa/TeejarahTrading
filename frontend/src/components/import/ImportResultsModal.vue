            ...
            <div class="flex items-start">
              ...
              <div class="flex-1">
                ...
                <div class="mt-3 flex flex-col sm:flex-row gap-2">
                  <a
                    href="https://journal.teejarah.com/docs/usage/importing-trades/#supported-brokers"
                    target="_blank"
...
const zeroTradeReason = computed(() => {
  ...
  if (!props.diagnostics?.detectedBroker && props.selectedBroker === 'auto') {
    return {
      title: 'Teejarah Trading could not recognize this export layout.',
  ...
  return {
    ...
    body: 'The file uploaded successfully, but it did not contain rows Teejarah Trading could turn into trades.',
    steps: [
...
const supportMailtoLink = computed(() => {
  ...
  return `mailto:support@journal.teejarah.com?subject=${subject}&body=${body}`
})
</script>
